                                            ...
                                            <div class="modal-dialog" role="document">
                                                ...
                                                <div class="modal-body">
                                                        <form method="POST" action="/handphone/create" enctype="multipart/form-data">
                                                                ...
                                                                <input id="golongan" type="hidden" name="golongan" class="form-control name="golongan" value="Handphone" >
                                                                <div class="form-group">
                                            ...
                                            <tbody>
                                                ...
                                                @if ($product->golongan == 'Handphone')        
                                                    <tr>
                                                        ...
                                                        <td>{{$product->harga}}</td>
                                                        <td>
                                                            <a href="/handphone/{{$product->id}}/edit" class="btn btn-primary btn-sm "><small>EDIT</small></a>
